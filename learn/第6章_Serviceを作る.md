...
> SecurityConfig の認可設定は第7章で本格化。ここでは `PasswordEncoder` だけ先に用意する。

---

## 🧱 6-4. ステップ① ResourceNotFoundException
...
## 🧱 6-7. ステップ④ CategoryService ― 持ち主チェック
...
## 🧱 6-8. ステップ⑤ TransactionService ― 詰め替え＋集計
...
- DTO は Entity ではない＝「集計結果を運ぶだけの箱」。画面に必要な形に整える
