...
（Controller / Service / Repository / Entity / Form）に作り替えながら学ぶ教材です。
...
| 6 | [第6章_Serviceを作る.md](./第6章_Serviceを作る.md) | ★パスワードのハッシュ化★／集計／持ち主チェック |
| 7-1 | [第7章_1_Controllerを作る.md](./第7章_1_Controllerを作る.md) | HTTPの入口／`@AuthenticationPrincipal` |
| 7-2 | [第7章_2_テンプレートとSecurityConfig.md](./第7章_2_テンプレートとSecurityConfig.md) | Thymeleaf／認可・ログイン・CSRF／起動 |
| 8 | [第8章_テストを書く.md](./第8章_テストを書く.md) | 単体テスト／`@WebMvcTest`・Mockito・`@DataJpaTest`／Boot4.0の注意点 |
